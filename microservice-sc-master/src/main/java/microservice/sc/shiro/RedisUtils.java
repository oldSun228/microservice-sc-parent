...
public class RedisUtils<K, V> {
     ...
     * @return true 存在 false不存在
     */
    public boolean hHasKey(K key, V item) {
     ...
     * @return
     */
    public double hincr(K key, V item, double by) {
    ...
    public Collection<Session> getActiveSessions(K key) {
        System.out.println("==============getActiveSessions=================");
        return (Collection<Session>) redisTemplate.keys(key);
    }
